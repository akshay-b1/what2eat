      ...
      <main className="flex-1 bg-gray-100 dark:bg-gray-800">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
          ...
          <div className="flex justify-center py-10">
            ...
            {surveyType === "cuisines" && ( <h4 className="text-sm font-bold">This is a live view of your group&apos;s choice. Click the map marker icon to get restaurant suggestions</h4> )}
